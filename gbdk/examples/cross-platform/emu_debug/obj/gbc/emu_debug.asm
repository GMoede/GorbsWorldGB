...
;src/emu_debug.c:138: EMU_MESSAGE("LY Register (0xFF44): %($ff44)%");
	.MACRO EMULOG138 msg_t, ?llbl 
	ld d, d 
	jr llbl 
	.dw 0x6464 
	.dw 0x0000 
...
llbl:
	.ENDM 
	EMULOG138 ^/"LY Register (0xFF44): %($ff44)%"/ 
;src/emu_debug.c:140: EMU_MESSAGE("Is LY Register > Line 67: %($ff44)>67%Yes;No;");
	.MACRO EMULOG140 msg_t, ?llbl 
	ld d, d 
	jr llbl 
	.dw 0x6464 
	.dw 0x0000 
...
llbl:
	.ENDM 
	EMULOG140 ^/"Is LY Register > Line 67: %($ff44)>67%Yes;No;"/ 
;src/emu_debug.c:146: EMU_MESSAGE("The following lines contain: PROFILE,(SP+$0),(SP+$1),A,TOTALCLKS,ROMBANK,WRAMBANK");
	.MACRO EMULOG146 msg_t, ?llbl 
	ld d, d 
	jr llbl 
	.dw 0x6464 
	.dw 0x0000 
...
llbl:
	.ENDM 
	EMULOG146 ^/"The following lines contain: PROFILE,(SP+$0),(SP+$1),A,TOTALCLKS,ROMBANK,WRAMBANK"/ 
;src/emu_debug.c:148: EMU_profiler_message();
	call	_EMU_profiler_message
;src/emu_debug.c:151: EMU_MESSAGE("PROFILE,%(SP+$0)%,%(SP+$1)%,%A%,%TOTALCLKS%,%ROMBANK%,%WRAMBANK%");
	.MACRO EMULOG151 msg_t, ?llbl 
	ld d, d 
	jr llbl 
	.dw 0x6464 
	.dw 0x0000 
...
llbl:
	.ENDM 
	EMULOG151 ^/"PROFILE,%(SP+$0)%,%(SP+$1)%,%A%,%TOTALCLKS%,%ROMBANK%,%WRAMBANK%"/ 
