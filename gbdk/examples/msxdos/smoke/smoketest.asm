...
;smoketest.c:29: set_bkg_data(2, earth_data_size >> 4, earth_data);
	...
	srl	h
	rr	l
;../../../include/msx/msx.h:576: set_native_tile_data(start, ntiles, src);
	push	bc
	push	hl
	ld	hl, #0x0002
	push	hl
...
;smoketest.c:30: set_sprite_data(0, earth_data_size >> 4, earth_data);
	...
	ld	b, a
	ld	c, h
;../../../include/msx/msx.h:579: set_sprite_1bpp_data(start, ntiles, src);
	ld	hl, #_earth_data
	push	hl
	push	bc
	ld	hl, #0x0000
...
;../../../include/msx/msx.h:742: shadow_OAM[nb].tile=tile;
	ld	hl, #_shadow_OAM+2
	ld	(hl), #0x00
	ld	hl, #_shadow_OAM+6
	ld	(hl), #0x02
...
;smoketest.c:72: move_sprite(0, x >> 4, y >> 4);
	...
	rr	l
	ld	c, l
;../../../include/msx/msx.h:777: OAM_item_t * itm = &shadow_OAM[nb];
;../../../include/msx/msx.h:778: itm->y=y, itm->x=x;
	ld	hl, #_shadow_OAM
	ld	(hl), b
	inc	hl
	ld	(hl), c
